...
import (
	...
	"github.com/crossplane-contrib/provider-jet-digitalocean/apis"
	pconfig "github.com/crossplane-contrib/provider-jet-digitalocean/config"
	"github.com/crossplane-contrib/provider-jet-digitalocean/internal/clients"
	"github.com/crossplane-contrib/provider-jet-digitalocean/internal/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-jet-digitalocean"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-jet-digitalocean",
	...
	kingpin.FatalIfError(controller.Setup(mgr, log, rl, setup, ws, pconfig.GetProvider(resourceMap), 1), "Cannot setup DigitalOcean controllers")
