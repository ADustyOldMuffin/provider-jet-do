...
// ResolveReferences of this DatabaseReplica.
func (mg *DatabaseReplica) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &DatabaseClusterList{},
			Managed: &DatabaseCluster{},
		},
	})
	if err != nil {
