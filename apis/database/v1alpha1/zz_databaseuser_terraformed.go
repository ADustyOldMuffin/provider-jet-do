...
func (tr *DatabaseUser) GetObservation() (map[string]interface{}, error) {
...
func (tr *DatabaseUser) SetObservation(obs map[string]interface{}) error {
...
func (tr *DatabaseUser) GetParameters() (map[string]interface{}, error) {
...
func (tr *DatabaseUser) SetParameters(params map[string]interface{}) error {
